...
```{r}
#chrom1 <- masker(chrom1, min_QUAL = 20, min_DP = 100, max_DP = 1000, min_MQ = 30)
chrom1 <- proc.chromR(chrom1, win.size=100000)
chromoqc(chrom1)
```
...
```{r}
gl_chr1 <- vcfR2genlight(vcf1, n.cores=4) # for adegenet

gid_chr1 <- vcfR2genind(vcf1, return.alleles = TRUE) # for poppr
